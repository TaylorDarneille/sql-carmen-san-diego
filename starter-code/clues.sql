...
world=# SELECT * FROM countries WHERE region='Southern Europe' ORDER BY population ASC;
...
world=# SELECT * FROM countrylanguages WHERE language='Italian' ORDER BY percentage DESC;
 countrycode | language | isofficial | percentage
-------------+----------+------------+------------
 SMR         | Italian  | t          |        100
 ITA         | Italian  | t          |       94.1
